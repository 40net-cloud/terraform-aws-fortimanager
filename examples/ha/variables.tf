...
variable "fmg1_private_ip" {
  description = "Reserved private IP for FortiManager 1. Leave empty for dynamic assignment."
  type        = string
  default     = ""
}

variable "fmg2_private_ip" {
  description = "Reserved private IP for FortiManager 2. Leave empty for dynamic assignment."
  type        = string
  default     = ""
}
